...
and c_exception = { mutable exc_name : string; mutable exc_id : int; } 
and c_fun = {
...
and c_env_obj =
  ...
  | C_array of c_array
  | C_enum of c_enum
  | C_type of Cp_types.data_type
  | C_abstract_type of Cp_types.abstract_object
  | C_exception of c_exception
  | C_storage of c_storage
  | C_abstract of c_abstract
  | C_fun of c_fun
  | C_unknown
and c_level = C_level_high | C_level_mid | C_level_low
and c_env = {
