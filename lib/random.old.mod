...
begin
  ...
  begin
    ...
    begin
      RND_$O_data_shift <= to_logic($seed,8);
...
begin
  ...
  begin
    if $RES or RND_$O_init = '1' then
    begin
      RND_$O_data_shift <= to_logic($seed,10);
...
begin
  ...
  begin
    if $RES or RND_$O_init = '1' then
    begin
      RND_$O_data_shift <= to_logic($seed,12);
...
begin
  ...
  begin
    if $RES or RND_$O_init = '1' then
    begin
      RND_$O_data_shift <= to_logic($seed,14);
...
begin
  ...
  begin
    if $RES or RND_$O_init = '1' then
    begin
      RND_$O_data_shift <= to_logic($seed,16);
