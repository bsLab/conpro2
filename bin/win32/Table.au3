...
;                  $iWidths - Initial width of each cell [array]
...
; Author ........: AndyBiochem
; ===========================================================================================
Func _GUICtrlTable_Create($iLeft, $iTop, $iWidths, $iHeight, $iRows, $iColumns, $iGapWidth = 1)
	...
	For $i = 1 To $iRows
		For $j = 1 To $iColumns
			$array[$i][$j] = GUICtrlCreateLabel("", $iLeft + $iCurrBoxLeft, $iTop + $iCurrBoxTop, $iWidths[$j-1], $iHeight)
			GUICtrlSetBkColor(-1, 0xFFFFFF)
			$iCurrBoxLeft += $iWidths[$j-1] + $iGapWidth
		Next
		$iCurrBoxLeft = 0
...
Func _GUICtrlTable_Set_ColumnWidth(ByRef $array, $iCol, $iWidth)
    ...
    ; safe fail test
    If IsArray($aTemp) = 0 Then Return
    If IsArray($aTemp2) = 0 Then Return
