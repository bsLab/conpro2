...
set halfperiod [div [get period] 2]
...
: make_pat
  ...
  set time_end [add [mul [get clock_cycles] [get period]] [get halfperiod]]
  pat event_seq clk 0 [mul [get period] [get clock_cycles]] [get period] 0 1 [get halfperiod] 0 
  pat event reset 0 1 [mul [get reset_cycles] [get period]] 0 [get time_end] 0 
  cd ..
